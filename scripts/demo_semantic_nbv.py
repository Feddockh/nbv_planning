...
EXPERIMENT_NAME = "semantic_nbv_default"  # Subfolder name for outputs
...
if LOGGING:
    ...
    octomap_points_path = os.path.join(logger.data_dir, "semantic_octomap_points.npz")
    octomap_labels_path = os.path.join(logger.data_dir, "semantic_octomap_labels.npz")
